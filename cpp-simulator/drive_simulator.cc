...
int main(int argc, char** argv){
  ...
  options.add_options("Other")
    ...
    ("VACCINATION_EFFECTIVENESS", "vaccination effectiveness",
     cxxopts::value<double>()->default_value(DEFAULTS.VACCINATION_EFFECTIVENESS))
    ("INFECTIOUSNESS_NEW_STRAIN", "new strain increases infectiousness by this factor",
    cxxopts::value<double>()->default_value(DEFAULTS.INFECTIOUSNESS_NEW_STRAIN))
    ...
    ("REINFECTION", "fraction of recovered people eligible for reinfection on Feb 1,2021",
     cxxopts::value<double>()->default_value(DEFAULTS.REINFECTION))
    ("FRACTION_NEW_STRAIN", "fraction of infected people infected with new strain on Feb 1,2021",
  ...
  GLOBAL.VACCINATION_EFFECTIVENESS = optvals["VACCINATION_EFFECTIVENESS"].as<double>();
  GLOBAL.INFECTIOUSNESS_NEW_STRAIN = optvals["INFECTIOUSNESS_NEW_STRAIN"].as<double>();
  GLOBAL.VIRULENT_NEW_STRAIN = optvals["VIRULENT_NEW_STRAIN"].as<double>();
  GLOBAL.REINFECTION = optvals["REINFECTION"].as<double>();
  ...
  std::string csv_file_name = "infections_from_new_strain"+std::to_string(GLOBAL.NUM_DAYS)+".csv";
